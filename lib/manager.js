...
Manager.prototype.onClose = function (id) {
  ...
  var self = this;
  	...
  	// apparently onClose  happens to get called for clients of the same node too so we need to make sure
	if(!this.transports[id])	// if it's actually a different node
